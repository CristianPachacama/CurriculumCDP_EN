...
\skills{{Html | CSS | LateX /4.4},{ C++ | Hadoop | Qlik Sense /3.7},{Python | SQL | Tableau /4.9},{R | Matlab | Power BI /5.6}}
...
\newline \textbf{DB Manager (Recover)}
...
\begin{twenty} % Environment for a list with descriptions
	...
	\twentyitem{2019-2020}{BI Analyst \\
	Business Intelligence Departament}{}
	{RECOVER Ecuador}
